...
public class Tela {
    ...
    private void criarCompetidores() {
        ...
        competidores.add(new Corredor("Joao", 4));
        competidores.add(new Corredor("Maria", 5));
        competidores.add(new Corredor("Marcos", 3));
        competidores.add(new Corredor("Rafaela", 6));
        competidores.add(new Corredor("Pedro", 5));
    }
    ...
    private void iniciarCorrida() {
        ...
        if (distanciaDaCorrida > 0) {
            ...
            for(Competidor competidor: competidores){
                competidor.prepararParaNovaCorrida(distanciaDaCorrida);
    ...
    private boolean temCompetidoresCorrendo(){
        for(Competidor competidor: competidores){
