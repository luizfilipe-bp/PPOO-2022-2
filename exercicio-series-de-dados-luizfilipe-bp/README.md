[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=9796465&assignment_repo_type=AssignmentRepo)
# Séries de Dados
...
> Dados de jogadores: número de jogadores que abriram o jogo, quantidade total de horas jogadas.
...
> A classe VisualizadorSeries conseguiu utilizar as informações das séries que foram implementadas por conta da interface SerieDados que foi implementada na classe SerieDadosJogo.

3. O que o polimorfismo tem a ver com o que foi feito?

> Com o polimorfismo, a classe visualizadorSeries pode acessar os métodos que estão presentes na interface SerieDados independente da classe. Se outra classe implementar a interface SerieDados também será possível acessar os métodos da interface.

4. Para que então servem as interfaces (como tipo de dado)?

> As interfaces como tipo de dado servem para definir métodos públicos e abstratos que serão implementados por uma classe. Assim, mantendo um padrão na assinatura dos métodos que são implementados pelas classes e criando uma hierarquia de métodos necessária para o polimorfismo.
