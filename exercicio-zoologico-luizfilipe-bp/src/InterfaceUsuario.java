...
public class InterfaceUsuario {
    ...
    private void cadastrarAnimal() {
        ...
        String especie = pedirString("Digite o nome da especie do animal");

        if(especie.equals("Ema")){
            String qualidadeVoo = pedirString("Digite a qualidade do voo");
            zoologico.adicionarEma(nome, qualidadeVoo);

        }else if(especie.equals("Leao")){
            String corDoPelo = pedirString("Digite a cor do pelo");
            zoologico.adicionarLeao(nome, corDoPelo);

        }else if(especie.equals("Gorila")){
            String corDoPelo = pedirString("Digite a cor do pelo");
            zoologico.adicionarGorila(nome, corDoPelo);

        }else if(especie.equals("Arara")){
            String qualidadeVoo = pedirString("Digite a qualidade do voo");
            zoologico.adicionarArara(nome, qualidadeVoo);

        }else{
            System.out.println("Espécie não foi encontrada para realizar o cadastro. ");
            return;
        }
    ...
    private void listarAnimais() {
        System.out.println(zoologico.getDescricaoResumidaTodos());
    }
    ...
    private void listarAnimaisCompleto() {
        System.out.println(zoologico.getDescricaoLongaTodos());
    }
}