...
public class CaixaEletronicoHashMap {
    //Atributos
    private HashMap<Integer, Conta> contas;
    private Scanner entrada;

    //Construtor
    public CaixaEletronicoHashMap() {
...
//Cria a conta a partir dos métodos criarCliente e definirLimite 
    private void criarConta(){
        ...
        contas.put(contaCriada.getNroConta(), contaCriada);
    }
...
//Seleciona qual conta irá sofrer alguma mudança
    ...
    private void removerConta(){
        ...
        if(contaSelecionada.getSaldo() == 0){
            contas.remove(contaSelecionada.getNroConta());
