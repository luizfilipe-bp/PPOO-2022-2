...
public class FeedNoticias {
    ...
    //Método que retorna as publicações de um autor em especifico
    ...
    // método que retorna verdadeiro quando um novo autor é adicionado na lista de autores
    private boolean adicionarAutor(String nomeAutor) {
