[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=9886139&assignment_repo_type=AssignmentRepo)
# Rede Social Gráfica
...
Para evitar esse problema pode-se verificar se a variável mensagem é nula. Os métodos podem ter seus tipos de retorno alterados para boolean, assim outra classe que utilize esses métodos podem verificar se foi possível curtir ou comentar uma mensagem através do que é recebido pelo retorno. As desvantagens de utilizar a abordagem de notificação da classe cliente são, as classes clientes podem ignorar os retornos dos métodos, o retorno do boolean pode ser um caso válido e não um erro e não é possível utilizar essa abordagem em um construtor, pois construtores não possuem retorno.
